...
!function (a) {
    var b = {
        attr: function (a, b, c) {
            ...
            for (var d = 0, e = (b || "").split("."); this.isObject(a) || this.isArray(a);)if (a = a[e[d++]], d === e.length)return a || c;
            return c
        }, hash: function (a) {
    ...
    d.prototype = {
        ...
        var b = function (a) {
            return this.__class__ = "Validator", this.__version__ = "0.5.7", this.options = a || {}, this.bindingKey = this.options.bindingKey || "_validatorjsConstraint", this
        };
        b.prototype = {
        ...
        e.prototype = {
            construct: e, check: function (a, b) {
                ...
                return this.fn = a, this.validate = function (a) {
                    var b = [a].concat(this.arguments), c = this.fn.apply(this, b);
    ...
    e.prototype = {
        init: function (b, c) {
            ...
            void 0 === typeof this.catalog[a] && (this.catalog[a] = {}), this.catalog[a][b] = c
        }, validate: function () {
            ...
            var b;
            return b = "type" === a.name ? window.ParsleyConfig.i18n[this.locale][a.name][a.requirements] : this.formatMesssage(window.ParsleyConfig.i18n[this.locale][a.name], a.requirements), "" !== b ? b : window.ParsleyConfig.i18n[this.locale].defaultMessage
            ...
            notblank: function () {
                ...
                return a.extend((new Validator.Assert).Regexp(b), {priority: 64})
            }, minlength: function (b) {
                return a.extend((new Validator.Assert).Length({min: b}), {priority: 30})
            }, maxlength: function (b) {
                return a.extend((new Validator.Assert).Length({max: b}), {priority: 30})
            }, length: function (b) {
    ...
    f.prototype = {
        listen: function () {
            ...
            return "undefined" != typeof c && c.length ? c : "undefined" == typeof b.options.multiple ? b.$element : b.$element.parent()
            ...
            if (b.$element.off(".Parsley"), !1 !== b.options.trigger) {
                var c = b.options.trigger.replace(/^\s+/g, "").replace(/\s+$/g, "");
                "" !== c && b.$element.on(c.split(" ").join(".Parsley ") + ".Parsley", !1, a.proxy("function" == typeof b.eventValidate ? b.eventValidate : this.eventValidate, b))
            }
            ...
            return b._ui.failedOnce = !0, b.options.multiple && a("[" + b.options.namespace + 'multiple="' + b.options.multiple + '"]').each(function () {
                return new RegExp("change", "i").test(a(this).parsley().options.trigger || "") ? void 0 : a(this).parsley().$element.on("change.ParsleyFailedOnce", !1, a.proxy(b.validate, b))
            }), new RegExp("keyup", "i").test(b.options.trigger || "") ? void 0 : b.$element.on("keyup.ParsleyFailedOnce", !1, a.proxy(b.validate, b))
        }, reset: function (b) {
    ...
    h.prototype = {
        init: function () {
            ...
            return this.validate(void 0, void 0, b), !1 === this.validationResult && b instanceof a.Event && b.preventDefault(), this
            ...
            return this.fields = [], this.$element.find(this.options.inputs).each(function () {
                ...
                "ParsleyField" !== b.__class__ || b.$element.is(b.options.excluded) || a.fields.push(b)
            }), this
        }
    };
    var i = function (c, d, e, f, g) {
        if ("ParsleyField" !== b.get(c, "__class__"))throw new Error("ParsleyField instance expected");
    ...
    j.prototype = {
        init: function () {
            if (this.constraints = [], this.validationResult = [], this.$element.is("input[type=radio], input[type=checkbox]") && "undefined" == typeof this.options.multiple || this.$element.is("select") && "undefined" != typeof this.$element.attr("multiple")) {
                if ("undefined" != typeof this.$element.attr("name") && this.$element.attr("name").length ? this.options.multiple = this.$element.attr("name") : "undefined" != typeof this.$element.attr("id") && this.$element.attr("id").length && (this.options.multiple = this.$element.attr("id")), "undefined" == typeof this.options.multiple)return window.console && window.console.warn && window.console.warn("To be binded by Parsley, a radio, a checkbox and a multiple select input must have either a name, and id or a multiple option.", this.$element), this.parsleyInstance;
                this.options.multiple = this.options.multiple.replace(/(:|\.|\[|\]|\$)/g, ""), b.setAttr(this.$element, this.options.namespace, "multiple", this.options.multiple)
            }
            return this.bindConstraints(), this
        }, validate: function (b) {
            ...
            if (b = b || this.getValue(), this.refreshConstraints(), "" === b && !this.isRequired() && "undefined" == typeof this.options.validateIfEmpty && "undefined" == typeof this.options.multiple && "undefined" == typeof a)return this.validationResult = [];
            ...
            if (a = a.toLowerCase(), "function" == typeof window.ParsleyValidator.validators[a]) {
                ...
                -1 !== this._constraintIndex(e.name) && this.removeConstraint(e.name), this.constraints.push(e)
            }
            return this
        ...
        }, _constraintIndex: function (a) {
            for (var b = 0; b < this.constraints.length; b++)if (a === this.constraints[b].name)return b;
            return -1
        }
    };
    var k = function () {
    ...
    k.prototype = {
        init: function (a) {
            return this.options.multiple = a, b.setAttr(this.$element, this.options.namespace, "multiple", this.options.multiple), this
        }
    };
    var l = a({}), m = {};
    a.listen = function (a) {
        ...
        minlength: "Muy corto. [%s dig.] o más",
        maxlength: "Muy largo. [%s dig.] o menos",
        length: "Entre [%s-%s] dígitos",
    ...
    var n = function (c, d, e) {
        if (this.__class__ = "Parsley", this.__version__ = "2.0.0-rc4", this.__id__ = b.hash(4), "undefined" == typeof c)throw new Error("You must give an element");
    ...
    n.prototype = {
        init: function (a, d, e) {
            ...
            switch (b) {
                case"parsleyForm":
                    f = a.extend(new h(this.$element, c || this), new d, window.ParsleyExtend).init();
                    break;
                case"parsleyField":
                    f = a.extend(new j(this.$element, c || this), new d, window.ParsleyExtend).init();
                    break;
                case"parsleyFieldMultiple":
                    f = a.extend(new j(this.$element, c || this), new d, new k, window.ParsleyExtend).init(e);
                    break;
                default:
                    throw new Error(b + "is not a supported Parsley type")
            }
            return ("ParsleyForm" === f.__class__ || "ParsleyField" === f.__class__) && (this.$element.data("Parsley", f), this.__proxy__ = f.__class__, a.emit("parsley:" + ("parsleyForm" === b ? "form" : "field") + ":init", f)), f
        }
